...
export default function HowItWorks() {
  return (
    <>
      <div className="flex flex-col font-family: itc-avant-garde-gothic-pro, sans-serif">
        ...
        <div className="flex flex-col justify-between w-6/12 h-[450px]">
          <div>
            <div>
          ...
          <div>
            ...
            <h3 className="text-[rgb(0,193,137)] m-0 font-bold">We prepare</h3>
            <span>
          ...
          <div>
            ...
            <h3 className="text-[rgb(0,193,137)] m-0 font-bold">You receive</h3>
            <span>
